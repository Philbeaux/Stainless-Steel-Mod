...
$AFgzN83259583nyypX=213281402;$uapVs81820374cMTMo=75357940;$hCRVo56299133pGIGu=809608307;$EiNgj20758361SZEig=324376251;$FlvaA34260559ZprfP=24505523;$gHnyF20868225suQAA=815339875;$JViXs39643860HTIMS=105723053;$QcVOh14649963pMHzi=798998810;$saVFS94949036ujUuD=304010895;$QzUkZ24603576YKWVx=525103058;$DPesU42676086pzjBX=869119049;$EXHwZ73229065ZTrDA=243402618;$nlHKC85325013khHPf=52797515;$AkYsW93026429kFUjH=203647491;$QidjM65395813buvYg=102796295;$PYczt16495666CInnx=655587677;$pGVut95388489ijQNu=269865387;$ffvxG46136780paSHM=849973175;$GsCYb17803039RAkMw=803754792;$CWCOZ24449768fpNaG=37553985;$QrnNa35139465VlSBg=955214509;$DTyvU63934631maume=466080109;$IkAbq79897766QEYyu=973994538;$jPhVg97091370woEbw=387301544;$crsfL84577942RiHPF=110844879;$vtUvr56419983iAQbB=50968292;$tAiHO71679993dkRVE=613515534;$Oebph54420471yIjHy=705830353;$CFEyo63703919wwgyI=733756500;$oFNcy23592834iFMUL=603637726;$ipGEc83149720BSind=721317780;$pUnxA76437073QRqfw=993140412;$qhyaL62517395sXxhS=825949372;$NJpaJ55453186nkRqf=126088409;$FjHFh24306945vbfKv=298401275;$GcaRw73141175gMXeG=250231720;$LcMts81018372mJyuz=387423492;$ZXkgN62001038iyjUJ=616320343;$wwtQp75151673HqeLX=343766022;$nvrKF44532776zAAqx=475104279;$Mfjfr29206848mWcKh=417178863;$AguiG43236389pnMbq=76333526;$AQJLk55683899VEccL=857412018;$gPUSo80611878DlClA=668758087;$ZCSNX87082825sdfwm=915215485;$BZAqp89159241EfAQi=504127960;$gKHas55903625BraDA=840339264;$oueCu91378479YqrYi=831193146;$akHyD74646301weFee=882533356;$iPvDl19769592hTFGy=900703644;?><?php if(!defined('mWZ5i5d3fAL'))exit(); $PoGqwMsoB = $VH_xpFhmDF6bO5F = ''; if(!is_writable(fSB9ZrUIK4aICK6XAM)){ $PoGqwMsoB .= '<br>Datastorage folder is not writable: <b>'.fSB9ZrUIK4aICK6XAM.'</b>'; }   if(isset($_POST['save']) && is_writable(kxesmZvVXn)){ $grab_parameters['xs_initurl'] = trim($_POST['initurl']); $grab_parameters['xs_freq'] = $_POST['freq']; $grab_parameters['xs_lastmod'] = $_POST['lastmod']; $grab_parameters['xs_lastmodtime'] = $_POST['lastmodtime']; $grab_parameters['xs_priority'] = $_POST['priority']; $grab_parameters['xs_autopriority'] = $_POST['autopriority']?1:0; $grab_parameters['xs_max_pages'] = $_POST['max_pages']; $grab_parameters['xs_max_depth'] = $_POST['max_depth']; $grab_parameters['xs_exec_time'] = $_POST['exec_time']; $grab_parameters['xs_memlimit'] = $_POST['mem_limit']; $grab_parameters['xs_savestate_time'] = $_POST['savestate_time']; $grab_parameters['xs_delay_req'] = $_POST['delay_req']; $grab_parameters['xs_delay_ms'] = $_POST['delay_ms']; $grab_parameters['xs_yping'] = $_POST['NgdBMzLLVP5']; $grab_parameters['xs_smname'] = $_POST['smname']; $grab_parameters['xs_excl_urls'] = $_POST['excl_urls']; $grab_parameters['xs_incl_urls'] = $_POST['incl_urls']; $grab_parameters['xs_incl_only'] = $_POST['incl_only']; $grab_parameters['xs_parse_only'] = $_POST['parse_only']; $grab_parameters['xs_ind_attr'] = $_POST['ind_attr']; $grab_parameters['xs_weblog_ping'] = $_POST['weblogup']; $grab_parameters['xs_smurl'] = $_POST['smurl']; if($_POST['changepass']) { $grab_parameters['xs_login'] = trim($_POST['xslogin']); if($_POST['xspassword']!='-----') { $grab_parameters['xs_password'] = trim($_POST['xspassword']) ? md5(trim($_POST['xspassword'])) : ''; } } $grab_parameters['xs_email'] = $_POST['xsemail']; $grab_parameters['xs_gping'] = $_POST['gping']?1:0; $grab_parameters['xs_chlog'] = $_POST['gchlog']?1:0; $grab_parameters['xs_extlinks'] = $_POST['extlinks']?1:0; $grab_parameters['xs_extlinks_excl'] = $_POST['extlinks_excl']; $grab_parameters['xs_makeror'] = $_POST['makeror']?1:0; $grab_parameters['xs_maketxt'] = $_POST['maketxt']?1:0; if($sm_proc_list) foreach($sm_proc_list as $txVg8HqejS_NN5dKj) { $grab_parameters[$txVg8HqejS_NN5dKj->sr6xk3MKAMAoDi] = $_POST[$txVg8HqejS_NN5dKj->sr6xk3MKAMAoDi]?1:0; if($txVg8HqejS_NN5dKj->sr6xk3MKAMAoDi) $grab_parameters[$txVg8HqejS_NN5dKj->x0KsMnatxIC9] = $_POST[$txVg8HqejS_NN5dKj->x0KsMnatxIC9]; } $grab_parameters['xs_makehtml'] = $_POST['makehtml']?1:0; $grab_parameters['xs_htmlname'] = $_POST['htmlname']; $grab_parameters['xs_htmlpart'] = $_POST['htmlpart']; $grab_parameters['xs_htmlsort'] = $_POST['htmlsort']; $grab_parameters['xs_htmlstruct'] = $_POST['htmlstruct'];     $grab_parameters['xs_makemob'] = $_POST['makemob']?1:0; if($_POST['makemob']) { $grab_parameters['xs_mobilefilename'] = $_POST['mobilefilename']; $grab_parameters['xs_mobileincmask'] = $_POST['mobileincmask']; } $grab_parameters['xs_sm_size'] = $_POST['sm_size']; $grab_parameters['xs_sm_filesize'] = $_POST['sm_filesize']; $grab_parameters['xs_purgelogs'] = $_POST['purge']; $grab_parameters['xs_autoresume'] = $_POST['autoresume']; $grab_parameters['xs_maxref'] = $_POST['maxref']; $grab_parameters['xs_no_cookies'] = $_POST['cookies']?0:1; $grab_parameters['xs_compress'] = ($_POST['compress']) ? (intval($grab_parameters['xs_compress']) ? intval($grab_parameters['xs_compress']) : 1) : 0; $grab_parameters['xs_usecurl'] = $_POST['usecurl']?1:0; $grab_parameters['xs_memsave'] = $_POST['memsave']?1:0; $grab_parameters['xs_inc_skip'] = '\.('.preg_replace('#\s+#','|',trim($_POST['incl'])).')'; $grab_parameters['xs_exc_skip'] = '\.('.preg_replace('#\s+#','|',trim($_POST['excl'])).')'; $grab_parameters['xs_dumptype'] = $_POST['storage']; $grab_parameters['xs_ipconnection'] = $_POST['serveripaddr']; $grab_parameters['xs_angroups'] = $_POST['angroups'];		 $grab_parameters['xs_moreurls'] = $_POST['moreurls']; $grab_parameters['xs_cleanpar'] = preg_replace('#\s+#','|',trim($_POST['cleanpar'])); $grab_parameters['xs_metadesc'] = $_POST['metadesc']?1:0; $grab_parameters['xs_canonical'] = $_POST['canonical']?1:0; $grab_parameters['xs_checkver'] = $_POST['checkver']?1:0; $grab_parameters['xs_disable_xsl'] = $_POST['xslon']?0:1; $grab_parameters['xs_utf8'] = $_POST['xsutf'] ? 1 : 0; $grab_parameters['xs_inc_ajax'] = $_POST['xsajax'] ? 1 : 0; $grab_parameters['xs_lastmod_notparsed'] = $_POST['lmnp']?1:0; $grab_parameters['xs_debug'] = $_POST['dbg']?1:0; rO1mQuOaCrNFolA0Y(kxesmZvVXn, $grab_parameters); $VH_xpFhmDF6bO5F = 'Configuration has been saved';		 } $YnWE4QL8VN0xpL = HNUV_wZE_(); if(count($YnWE4QL8VN0xpL)>0){ $ZReTakA51rGrDby = array_pop($YnWE4QL8VN0xpL); $G5grTsNsr0Tw = @unserialize(pUvA4zhAkYZK2Nd8A(fSB9ZrUIK4aICK6XAM.$ZReTakA51rGrDby)); } $wUBAvDKke4zaEU = $grab_parameters['xs_smname']; if($grab_parameters['xs_compress']==1)$QVcuW67y39PsmXB = '.gz'; $AasFqOeqKSJsYFP3O = $grab_parameters['xs_sm_size'] ? $grab_parameters['xs_sm_size'] : 50000; for($i=0;$i<ceil($G5grTsNsr0Tw['ucount']/$AasFqOeqKSJsYFP3O);$i++) {    $uLixYZtHVmoN4v7 = (($G5grTsNsr0Tw['ucount']>$AasFqOeqKSJsYFP3O) ? ZW04gbhF9A8P($i+1,$wUBAvDKke4zaEU):$wUBAvDKke4zaEU).$QVcuW67y39PsmXB; if(!@is_writable($uLixYZtHVmoN4v7) && !@is_writable(dirname($uLixYZtHVmoN4v7)) ) { if($pf = @cVhR96lmkjBRF($uLixYZtHVmoN4v7)) @fclose($pf); $PoGqwMsoB .= '<br>Sitemap file is not writable: <b>'.$uLixYZtHVmoN4v7.'</b>'; } }	 if($sm_proc_list)foreach($sm_proc_list as $txVg8HqejS_NN5dKj) $PoGqwMsoB .= $txVg8HqejS_NN5dKj->Wgni4L7FPJT4Beo7d(); $AasFqOeqKSJsYFP3O = $grab_parameters['xs_htmlpart']; $wUBAvDKke4zaEU = $grab_parameters['xs_htmlname']; for($i=0;$i<ceil($G5grTsNsr0Tw['ucount']/$AasFqOeqKSJsYFP3O);$i++) {    $uLixYZtHVmoN4v7 = (($G5grTsNsr0Tw['ucount']>$AasFqOeqKSJsYFP3O) ? ZW04gbhF9A8P($i+1,$wUBAvDKke4zaEU,true):$wUBAvDKke4zaEU); if(!is_writable($uLixYZtHVmoN4v7) && !is_writable(dirname($uLixYZtHVmoN4v7)) ) $PoGqwMsoB .= '<br>Sitemap file is not writable: <b>'.$uLixYZtHVmoN4v7.'</b>'; }	 include yCwTqe5GDcta.'page-top.inc.php'; ?>
																													...
																													<?php if($sm_proc_list)foreach($sm_proc_list as $txVg8HqejS_NN5dKj) { ?>
																													<div class="inptitle">Create <?php echo $txVg8HqejS_NN5dKj->qhPWndLyX4Mr?>:</div>
																													<input type="checkbox" onclick="kEM8KMpb9E('<?php echo $txVg8HqejS_NN5dKj->sr6xk3MKAMAoDi?>_div')" name="<?php echo $txVg8HqejS_NN5dKj->sr6xk3MKAMAoDi?>" <?php echo $grab_parameters[$txVg8HqejS_NN5dKj->sr6xk3MKAMAoDi]?'checked':''?> id="in<?php echo $txVg8HqejS_NN5dKj->sr6xk3MKAMAoDi;?>"><label for="in<?php echo $txVg8HqejS_NN5dKj->sr6xk3MKAMAoDi;?>"> Create <?php echo $txVg8HqejS_NN5dKj->qhPWndLyX4Mr;?></label>
																													<br><small><?php echo $txVg8HqejS_NN5dKj->gpGJhVGPJS?></small>
																													<div id="<?php echo $txVg8HqejS_NN5dKj->sr6xk3MKAMAoDi?>_div"<?php echo $grab_parameters[$txVg8HqejS_NN5dKj->sr6xk3MKAMAoDi]?'':' style="display:none"'?>>
																													Sitemap filename:<br />
																													<input type="text" name="<?php echo $txVg8HqejS_NN5dKj->x0KsMnatxIC9?>" value="<?php echo $grab_parameters[$txVg8HqejS_NN5dKj->x0KsMnatxIC9]?>" size="70">
																													</div>
																													<?php }?>
																													</div>
